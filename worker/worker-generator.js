...
async function handleRequest(request) {
    let title = getParameterByName(request.url, 'site_name') || 'Pirates Drive Index';
...
<head>
    ...
    <title>Pirtaes Drive Index - Beta</title>
...
<div class="container">
    <br><br>
    <a href="https://www.npmjs.com/package/@googledrive/index"><h3>Pirates Index Generator - Beta</h3></a>
    <br>
        <div>
            <h3>1. <a
...
<form>
  ...
  <button type="submit" class="btn btn-primary">Submit</button>
    ...
    <center><p>© <span id="year"></span> - Pirates Cloud</p></center>
</div>
